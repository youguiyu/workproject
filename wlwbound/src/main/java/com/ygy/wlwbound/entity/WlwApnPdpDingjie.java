...
public class WlwApnPdpDingjie {
    ...
    private String pdp_suc_rate_dingjie_conclusion;
    ...
    public String getPdp_suc_rate_dingjie_conclusion() {
        return pdp_suc_rate_dingjie_conclusion;
    }

    public void setPdp_suc_rate_dingjie_conclusion(String pdp_suc_rate_dingjie_conclusion) {
        this.pdp_suc_rate_dingjie_conclusion = pdp_suc_rate_dingjie_conclusion;
    }
